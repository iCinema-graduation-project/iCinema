...
extension UIView{
    ...
    public func fillSuperviewConstraints(padding: UIEdgeInsets = .zero) {
    ...
    public func fillXSuperViewConstraints(paddingLeft: CGFloat = 0, paddingRight: CGFloat = 0){
    ...
    public func fillYSuperViewConstraints(paddingTop: CGFloat = 0, paddingBottom: CGFloat = 0){
        translatesAutoresizingMaskIntoConstraints = false
