...
extension UIView {
    ...
    @discardableResult
    public func centerInSuperview(size: CGSize = .zero) -> AnchoredConstraints {
    ...
    @discardableResult
    public func centerXInSuperview() -> NSLayoutConstraint? {
        translatesAutoresizingMaskIntoConstraints = false
        if let superview = superview {
    ...
    @discardableResult
    public func centerYInSuperview() -> NSLayoutConstraint? {
        translatesAutoresizingMaskIntoConstraints = false
         if let superview = superview {
