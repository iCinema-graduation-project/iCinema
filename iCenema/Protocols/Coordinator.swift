...
// including managing a navigation controller and managing a stack of view controllers.
 class Coordinator {
    ...
    func push(userInfo: [String: Any]? = nil ) {
        ...
        let currentCoordinator = self.coordinators[currentIndex]
    ...
    func pop() {
     ...
     func push(to viewController: ViewController.Type, userInfo: [String: Any]? = nil ) {
         let currentCoordinator = viewController.init()
